// ===== Loyalsoldier 全局覆写脚本（v4.1 修复版）=====
// [v4.1 修复] Microsoft Store 打不开:
//   (1) direct 规则集提到 gfw/tld-not-cn 之前 (恢复 Loyalsoldier 标准顺序)
...
function main(config) {
    ...
    config.rules = [
        ...
        // Microsoft Store 整个应用按进程直连 (类似 Proxifier 的 per-app 规则, 置顶优先)
        // WinStore.App.exe = 商店主进程(catalog/授权); msedgewebview2.exe = 商店 UI 渲染
        // 注: msedgewebview2.exe 为 WebView2 共享进程, 若其它 WebView2 应用需走代理可删此行
