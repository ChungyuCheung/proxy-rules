...
// synology.me 是群晖公网 DDNS, 公共 DNS 全球可解析, 故归此类(在家也能访问)。
const SPLIT_DNS_DOMAINS = ["huinor.com", "huitone.com", "synology.me"]
// [纯内网] 仅公司 DNS 可解析; 在家解析不到属正常, 无法访问。
// 注: kunyi-pro / kunqi-gz 为单标签主机名(已确认非笔误)。只能靠公司 DNS 解析,
//     依赖系统的 DNS 后缀搜索列表(通常由公司 DHCP 下发); 公共 DNS 永远解不到, 故必须走 system://。
